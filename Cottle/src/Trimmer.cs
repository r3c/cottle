...
namespace Cottle
{
	...
	public static class Trimmers
	{
		...
		public static readonly Trimmer	CollapseBlankCharacters = (text) => Trimmers.collapseBlankCharacters.Replace (text, " ");
		...
		public static readonly Trimmer	LeadingAndTrailingBlankCharacters = (text) =>
		{
			int index;
			int start;
			int stop;
